...
IMPLEMENT_STANDARD_RTTIEXT(ProjLib_ProjectedCurveOnPlane, Adaptor2d_Curve2d)
...
Handle(Adaptor2d_Curve2d) ProjLib_ProjectedCurveOnPlane::ShallowCopy() const
{
  Handle(ProjLib_ProjectedCurveOnPlane) aCopy = new ProjLib_ProjectedCurveOnPlane();
...
void ProjLib_ProjectedCurveOnPlane::Load(const Handle(Adaptor3d_Surface)& S)
{
  mySurface = S ;
}
...
void ProjLib_ProjectedCurveOnPlane::Perform(const Handle(Adaptor3d_Curve)& C)
{
...
const Handle(Adaptor3d_Surface)& ProjLib_ProjectedCurveOnPlane::GetSurface() const
{
  return mySurface;
}
...
const Handle(Adaptor3d_Curve)& ProjLib_ProjectedCurveOnPlane::GetCurve() const
{
  return myCurve;
}
...
Handle(Adaptor2d_Curve2d) ProjLib_ProjectedCurveOnPlane::Trim
