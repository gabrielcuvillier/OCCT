...
//!
//! On light build mode supported formats are: bmp, png, and jpg are supported (no *.tga, *.gif, *.exr, *.tif, *.ppm)
//! Rationale: formats supported by both major Web Browsers and GLTF format + bmp as bonus.
